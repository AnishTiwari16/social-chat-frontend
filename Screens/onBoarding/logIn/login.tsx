      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={tw('py-28 px-10')}>
            <Text style={tw(' font-medium text-2xl text-gray-700')}>Login</Text>
            <View style={tw('py-12')}>
              <TextInput
              ...
              <View style={{ flexDirection: 'row' }}>
                <TextInput
                  style={tw('h-12 border-2 border-neutral-300 p-2.5 mb-5 flex-1')}
              ...
              <View style={tw('border-t-2 border-y-slate-300 mb-7')}></View>
              <TouchableOpacity onPress={() => navigation.navigate('SignUpEmail')}>
                <Text style={tw('text-center text-blue-500')}>Don't have an account? Signup</Text>
              </TouchableOpacity>
            </View>
            <Disclaimer />
          </View>
